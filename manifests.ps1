...
.DESCRIPTION
    Downloads depot manifests when AmeerXST servers are unavailable.
...
$Host.UI.RawUI.WindowTitle = "Steam FIXER"
...
function Write-Header {
    ...
    $esc = [char]27
    $discordLink = "$esc]8;;https://discord.gg/sJyvkBuH4x$esc\discord.gg/sJyvkBuH4x$esc]8;;$esc\"
    Write-Host "  +================================================================+" -ForegroundColor Cyan
    Write-Host "  |                               GIK                        |" -ForegroundColor Cyan
    Write-Host "  |                                                                     |" -ForegroundColor Cyan
